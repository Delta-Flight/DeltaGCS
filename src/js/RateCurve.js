...
const RateCurve = function (useLegacyCurve) {
    ...
    this.getDeltaflightRates = function (rcCommandf, rcCommandfAbs, rate, rcRate, rcExpo, superExpoActive, limit) {
        let angularVel;
...
RateCurve.prototype.rcCommandRawToDegreesPerSecond = function (rcData, rate, rcRate, rcExpo, superExpoActive, deadband, limit) {
    ...
    if (rate !== undefined && rcRate !== undefined && rcExpo !== undefined) {
        ...
        switch (FC.RC_TUNING.rates_type) {
            ...
            default: // Deltaflight
                angleRate=this.getDeltaflightRates(rcCommandf, rcCommandfAbs, rate, rcRate, rcExpo, superExpoActive, limit);

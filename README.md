# DeltaFlight Configurator

![DeltaFlight](http://static.rcgroups.net/forums/attachments/6/1/0/3/7/6/a9088900-228-bf_logo.jpg)

[![Latest version](https://img.shields.io/github/v/release/deltaflight/deltaflight-configurator)](https://github.com/deltaflight/deltaflight-configurator/releases) [![Build](https://img.shields.io/github/actions/workflow/status/deltaflight/deltaflight-configurator/nightly.yml?branch=master)](https://github.com/deltaflight/deltaflight-configurator/actions/workflows/nightly.yml) [![Crowdin](https://d322cqt584bo4o.cloudfront.net/deltaflight-configurator/localized.svg)](https://crowdin.com/project/deltaflight-configurator) [![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=deltaflight_deltaflight-configurator&metric=alert_status)](https://sonarcloud.io/dashboard?id=deltaflight_deltaflight-configurator) [![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0) [![Join us on Discord!](https://img.shields.io/discord/868013470023548938)](https://discord.com/invite/n4E6ak4u3c)


DeltaFlight Configurator is a crossplatform configuration tool for the DeltaFlight flight control system.

It runs as an application under different operating systems and allows you to configure the DeltaFlight software running on any supported DeltaFlight target. [Downloads are available in Releases.](https://github.com/deltaflight/deltaflight-configurator/releases)

Various types of aircraft are supported by the tool and by DeltaFlight, e.g. quadcopters, hexacopters, octocopters and fixed-wing aircraft.

## Authors

DeltaFlight Configurator is a [fork](#credits) of the Cleanflight Configurator with support for DeltaFlight instead of Cleanflight.

This configurator is the only configurator with support for DeltaFlight specific features. It will likely require that you run the latest firmware on the flight controller.

If you are experiencing any problems please make sure you are running the [latest firmware version](https://github.com/deltaflight/deltaflight/releases/).
...
Download the installer from [Releases.](https://github.com/deltaflight/deltaflight-configurator/releases)
...
Changes to the security model used in the latest versions of MacOS X 10.14 (Mojave) and 10.15 (Catalina) mean that the operating system will show an error message ('"DeltaFlight Configurator.app" is damaged and can’t be opened. You should move it to the Trash.') when trying to install the application. To work around this, run the following command in a terminal after installing: `sudo xattr -rd com.apple.quarantine /Applications/DeltaFlight\ Configurator.app`.
...
DeltaFlight Configurator has been translated into several languages. The application will try to detect and use your system language if a translation into this language is available. You can help [translating the application into your language](https://github.com/deltaflight/deltaflight/tree/master/README.md#translators);
...
https://discord.com/invite/n4E6ak4u3c

We also have a Facebook Group. Join us to get a place to talk about DeltaFlight, ask configuration questions, or just hang out with fellow pilots.
...
For DeltaFlight configurator issues raise them here

https://github.com/deltaflight/deltaflight-configurator/issues

For DeltaFlight firmware issues raise them here

https://github.com/deltaflight/deltaflight/issues
